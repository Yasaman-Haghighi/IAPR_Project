## CNN for 8 and flipped J Classification
...
max_epochs = 15  # maxmimum number of epochs to be iterated
batch_size = 400   # batch size for the training data set
...
dense_02 = Dense(2)(dense_01)
outputs = Activation('softmax')(dense_02)

model_8j = Model(inputs=inputs, outputs=outputs)
model_8j.compile(optimizer=optimizer_type, loss=loss, metrics=metrics)